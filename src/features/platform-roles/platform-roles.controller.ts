...
export const listPlatformRoles: AppRouteHandler<ListPlatformRolesRoute> = async (c) => {
  return c.json(await service.listRoles(), HttpStatusCodes.OK)
}

export const getPlatformRole: AppRouteHandler<GetPlatformRoleRoute> = async (c) => {
  try {
    return c.json(await service.getRole(c.req.valid("param").id), HttpStatusCodes.OK)
  } catch (error) {
...
export const createPlatformRole: AppRouteHandler<CreatePlatformRoleRoute> = async (c) => {
  try {
    return c.json(
...
export const updatePlatformRole: AppRouteHandler<UpdatePlatformRoleRoute> = async (c) => {
  try {
    return c.json(
...
export const deletePlatformRole: AppRouteHandler<DeletePlatformRoleRoute> = async (c) => {
  try {
